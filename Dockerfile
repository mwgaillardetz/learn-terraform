...
LABEL maintainer="terraform-exam-app"
LABEL description="Interactive Terraform Associate Practice Exam"
...
RUN echo 'server {' > /etc/nginx/conf.d/default.conf && \
    ...
    echo '    }' >> /etc/nginx/conf.d/default.conf && \
    echo '' >> /etc/nginx/conf.d/default.conf && \
    echo '    # Handle routing for single page application' >> /etc/nginx/conf.d/default.conf && \
